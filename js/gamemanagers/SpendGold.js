...
game.SpendGold = Object.extend({
    ...
    setBuyText: function() {
        game.data.buytext = new (me.Renderable.extend({
            ...
            draw: function(renderer) {
                ...
                this.font.draw(renderer.getContext(), "Skill 2: Run Faster" + game.data.skill2 + "Cost:" + ((game.data.skill2 + 1) * 10), this.pos.x, this.pos.y + 80);
                this.font.draw(renderer.getContext(), "Skill 3:Increase Health" + game.data.skill3 + "Cost:" + ((game.data.skill3 + 1) * 10), this.pos.x, this.pos.y + 120);
    ...
    checkCost: function(skill){
        if(skill===1 && (game.data >= (game.data.skill+1)*10)){
            return true;
        }else if(skill===2 && (game.data.gold >= ((game.data.skill2+1)*10))){
                return true;
        }else if(skill===3 && (game.data.gold >= ((game.data.skill3+1)*10))){
                 return true;
        }else if(skill===4 && (game.data.gold >= ((game.data.ability1+1)*1))){
            
             return true;
        }else if(skill===5 && (game.data.gold >= ((game.data.ability2+1)*1))){
            
             return true;
        }else if(skill===6 && (game.data.gold >= ((game.data.ability3+1)*1))){
            return true;
        }else{
            return false;
        }
